...
public class SingBoxOptions {
    ...
    public static class Endpoint extends SingBoxOption {
        ...
        // Generate note: option type:  public WireGuardEndpointOptions WireGuardOptions;

        // Generate note: option type:  public AwgEndpointOptions AwgOptions;
    ...
    public static class AwgPeerOptions extends SingBoxOption {
